...
plot "data_10.txt" every :1 using 1:2 with lines
...
plot "data_100.txt" every :1 using 1:2 with lines
...
plot "data_1000.txt" every :1 using 1:2 with lines